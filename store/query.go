...
type DBTX interface {
	...
	QueryRow(ctx context.Context, ssql string, args ...any) pgx.Row
...
func (q *Query) InsertRefreshToken(ctx context.Context, userID int, tokenHash []byte, expiresAt time.Time) (pgconn.CommandTag, error) {
