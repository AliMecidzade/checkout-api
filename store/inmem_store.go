...
func (s *InMemStore) GetItem(_ context.Context, id int) *models.Item {
	return s.items[id]
}
...
func (s *InMemStore) GetUserCart(_ context.Context, userID int) *models.Cart {
...
func (s *InMemStore) DeleteUserCart(_ context.Context, userID int) {
	delete(s.carts, userID)
}

func (s *InMemStore) UpdateCartItem(_ context.Context, userID int, itemID int, quantity int) bool {
	cart := s.carts[userID]
	if cart == nil {
		return false
	}
...
func (s *InMemStore) RemoveCartItem(_ context.Context, userID int, itemID int) bool {
	cart := s.carts[userID]
	if cart == nil {
		return false
	}
