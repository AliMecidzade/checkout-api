...
type OrderRepo interface {
	...
	ListOrdersByUser(ctx context.Context, userID int64, p domain.Page) ([]domain.Order, bool, error)
}

type CartRepo interface {
	UpsertCartItem(ctx context.Context, userID int64, itemID int64, quantity int64) error
	ListCart(ctx context.Context, userID int64, p domain.Page) ([]domain.CartItem, bool, error)
